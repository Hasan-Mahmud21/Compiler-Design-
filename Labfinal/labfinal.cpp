...
// Function to check if a string token is a keyword
bool isKeyword(const string& token) {
    vector<string> keywords = {"int", "float", "double", "char", "long", "short",
                               ...
                               "if", "else if", "else", "while", "do-while", "switch", "case", "default",
                               "break", "parameters", "return_type", "function_name", "continue_statements",
                               "arr", "array", "*ptr", "pointer", "class", "class_name", "object", "obj",
                               "inheritance", "polymorphism", "derived_class", "access_specifier", "base_class",
                               "virtual", "function", "function_overriding", "file_io", "ifstream", "ofstream",
                               "exception_handling", "try", "catch", "throw", "finally", "namespaces", "std",
                               "include", "unordered", "false", "true", "string", "cout", "cin", "for", "while",
                               "do", "switch", "case", "choice", "encapsulation", "constructors", "public",
                               "private", "get", "set", "main", "return", "structures", "struct", "loop"};
